...
| func_math.c | Contains functions math : ***_add, _sub, _mul, _div and others***
| function_stack.c |  Contains functions create stack and queues: ***_push, _pall, _swat,***
| function_stack1.c |  Contains functions create stack and queues: ***_pstr, _rotl, _rotr,***
| function_stack2.c | It contains other functions for print char such as: ***_pchar, _nop***
...
* **Faghil Nouhaila** - [FaghilNouhaila](https://github.com/FaghilNouhaila)
